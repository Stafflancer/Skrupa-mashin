...
class PluginOrganizer {
	...
	function check_version() {
		...
		if (get_option("PO_version_num") != "9.6.1" && !in_array($pagenow, array("plugins.php", "update-core.php", "update.php"))) {
			$this->activate();
		}
	}
	...
	function activate() {
		...
		if (get_option("PO_version_num") != "9.6.1") {
			update_option("PO_version_num", "9.6.1");
		}
